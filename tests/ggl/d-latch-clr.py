...
output0 = io.Output(bits=1, label="Q", js_id="output_1")
circuit0.connect(nor1, output0)    # nor1 -> output1

output1 = io.Output(bits=1, label="notQ", js_id="output_2")
circuit0.connect(nor2, output1)    # nor2 -> output2
