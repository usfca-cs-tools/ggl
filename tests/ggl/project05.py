...
rom3 = memory.ROM(label="quad", address_bits=8, data_bits=32, data=[44368563, 45253299, 46465843, 6456627, 13960499, 32871, 3221229683], js_id="rom_4_1754161955932")
...
circuit0.connect(counter_8bit_1.output("count"), a)    # counter_8bit_1 -> instruction_memory_1.in[0]
