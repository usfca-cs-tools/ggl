...
rom0 = memory.ROM(address_bits=4, data_bits=32, label="ROM")

# This test uses the alternative approach of the load_data() method
# rather than including the data on the constructor argument list
rom0.load_data([44368563, 45253299, 46465843, 6456627, 13960499, 32871, 3221229683, 0, 0, 0, 0, 0, 0, 0, 0, 0])
