...
input3.value = 1  # D = 1
d_flip_flop_1 = memory.Register(bits=8)
d_flip_flop_2 = memory.Register(bits=8)
d_flip_flop_3 = memory.Register(bits=8)
d_flip_flop_4 = memory.Register(bits=8)
d_flip_flop_5 = memory.Register(bits=8)
d_flip_flop_6 = memory.Register(bits=8)
d_flip_flop_7 = memory.Register(bits=8)
d_flip_flop_8 = memory.Register(bits=8)
